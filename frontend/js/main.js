    ...
    //   console.log(data)
		...
		// 	curModal.find(".ajax-modal-menu a[data-hash='" + hashVal + "']").addClass("active");
			...
			// curModal.on("shown.bs.modal", function () {
				...
				// if ($(this).find(".fabric-modal-bg").length) {
				//
				// 	$(".fabric-modal").on("resize scroll load", function () {
				//
				// 		$(".fabric-modal-bg img").each(function () {
				//
				// 			$(this).prlx2($(this).closest(".section"), 0, 150, true)
				//
				// 		});
				//
				// 	});
...
function initSliders() {
	...
	$(".prod-item-slider").each(function () {
